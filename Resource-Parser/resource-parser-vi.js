/** 
☑️ Trình phân tích tài nguyên ©𝐒𝐡𝐚𝐰𝐧 ⟦2023-05-02 13:40⟧
-------------------------------------------------- --------
🛠 Đã tìm thấy 𝐁𝐔𝐆 Vui lòng phản hồi: https://t.me/Shawn_Parser_Bot
⛳️ Theo dõi 🆃🅶 các kênh liên quan: https://t.me/QuanX_API
📖 Hướng dẫn: https://tinyurl.com/2jyygfom
🗣 🆃🄷🄰🄽🄺🅂 🆃🄾 @Jamie CHIEN, @M**F**, @c0lada, @Peng-YM, @vinewx, @love4taylor, @shadowdogy

🤖 Chức năng chính:
❶ Phân tích cú pháp ⟦Đăng ký máy chủ⟧ ở các định dạng khác thành định dạng 𝐐𝐮𝐚𝐧𝐭𝐮𝐦𝐮𝐥𝐭 𝐗
☑︎ Hỗ trợ 𝐕2𝐫𝐚𝐲𝐍/𝗦𝗦(𝗥/𝗗)/𝗛𝗧𝗧𝗣(𝗦)/𝗧𝗿𝗼𝗷𝗮𝗻/𝗤𝘂𝗮𝗻𝘁 𝘂 𝗺𝘂𝗹𝘁(𝗫)/𝗦𝘂𝗿𝗴𝗲/𝐂𝐥𝐚𝐬𝐡/𝐒𝐡𝐚𝐝𝐨𝐰𝐫𝐨𝐜𝐤𝐞𝐭/𝐋𝐨𝐨𝐧 định dạng
☑︎ Cung cấp các tham số cá nhân hóa tùy chọn (lọc, đổi tên, v.v.) từ hướng dẫn 1⃣️
❷ Chuyển thể & sàng lọc 𝗿𝗲𝘄𝗿𝗶𝘁𝗲(rewrite) & 𝗳𝗶𝗹𝘁𝗲𝗿(shunt)
☑︎ Được sử dụng để vô hiệu hóa/sửa đổi một (vài) mục nhất định trong tham chiếu từ xa
☑︎ Phân tích cách sử dụng của 𝐒𝐮𝐫𝐠𝐞/𝐂𝐥𝐚𝐬𝐡 loại quy tắc 𝗹𝗶𝘀𝘁 và mô-đun 𝐦𝐨𝐝𝐮𝐥𝐞
-------------------------------------------------- --------
0️⃣ Thêm "#" sau ⟦Liên kết đăng ký⟧ để sử dụng, sử dụng "&" để kết nối các tham số khác nhau
⚠️ ☞ "Liên kết đăng ký của bạn #emoji=1&tfo=1&in=Hong Kong+Taiwan"
❖ Tham chiếu đoạn tài nguyên cục bộ, vui lòng điền các tham số như "#in=xxx&out=yyy" vào dòng ① của đoạn tài nguyên
❖ 🚦 Hỗ trợ tiếng Trung, vui lòng thay thế (URL-Encode) khi "thao tác" các ký tự đặc biệt sau 🚦
   ∎ "+"⇒"%2B", dấu cách⇒"%20", "@"⇒"%40", "&"⇒"%26", "."⇒"\.", ","⇒"% 2C"

1️⃣ ⟦𝐬𝐞𝐫𝐯𝐞𝐫 nút ⟧ ➠ mô tả tham số:
⦿ emoji=1 (2 cho thiết bị của Ngân hàng Trung Quốc)/-1, thêm/xóa cờ khu vực trong tên nút;
⦿ udp=1/-1, tfo=1/-1, buộc mở (đóng) tương ứng 𝐮𝐝𝐩-𝐫𝐞𝐥𝐚𝐲/𝐟𝐚𝐬𝐭-𝐨𝐩𝐞𝐧;
⦿ uot=1, bật tùy chọn udp-over-tcp=true (chỉ SS(R))
⦿ cert=1/-1, lần lượt bật/tắt 𝐭𝐥𝐬 xác minh chứng chỉ (mặc định tắt);
   ❖ Các thông số csha/psha, tls-cert-sha256 và tls-pubkey-sha256
   ❖ alpn, chỉ định tham số alpn của nút loại over-tls
⦿ in, out, regex và regout tương ứng là các nút lưu giữ, xóa, lưu giữ thường xuyên và xóa thường xuyên;
   ❖ vào/ra chỉ hợp lệ đối với khớp tên nút, đa tham số (logic "hoặc") được biểu thị bằng "+", logic "và" được biểu thị bằng ".";
   ❖ regex/regout để khớp với thông tin đầy đủ của nút (loại, cổng, mã hóa, v.v.);
   ❖ Trình diễn: "in=Hong Kong.0\.2 ratio+Taiwan&out=BGP&regex=iplc"
⦿ đổi tên đổi tên, "tên cũ@tên mới", "tiền tố@", "@suffix", sử dụng "+" để kết nối nhiều tham số;
   ❖ Xóa trường: "Field1.Field2☠️", muốn xóa dấu "." thì thay dấu "\."
   ❖ Minh họa: "rename=Hong Kong@𝐇𝐊+[𝐒𝐒]@+@[1𝐗]+traffic.0\.2☠️"
   ❖ Emoji mặc định có hiệu lực trước, nếu bạn muốn thay đổi thứ tự vui lòng sử dụng tham số rrname
⦿ thay thế Thường xuyên thay thế các trường trong các nút, có thể được sử dụng để đổi tên/thay đổi phương thức mã hóa, v.v.
   ❖ thay thế=regex1@𝘀𝘁𝗿1+regex2@𝘀𝘁𝗿2
⦿ ptn/npt=1-8, thay thế tên nút bằng kiểu tiếng Anh/kiểu kỹ thuật số ⇒ 🅰/🄰/𝐀/𝗮/𝔸/𝕒/ᵃ/ᴬ, ①\❶\⓵\𝟙\¹\₁\𝟏\𝟷
⦿ xóa, sử dụng cụm từ thông dụng để xóa các trường trong "tên nút" (⚠️ sử dụng thận trọng)
⦿ aead=-1, tắt tham số AEAD của Vmess
⦿ host=xxx, sửa đổi máy chủ hiện có, nếu bạn muốn thêm máy chủ, vui lòng kết thúc bằng ☠️
⦿ obfs=vhttp/shttp, yêu cầu đặc biệt để chỉ định obfs=shadowsocks-http hoặc obfs=vmess-http
⦿ tsession=0/1/2, 0/1 nghĩa là đóng tls-session-ticket/reuse, 2 nghĩa là đóng tất cả
⦿ checkurl=xxx , chỉ định tham số server_check_url
⦿ sort=1/-1/x/quy tắc tham số, sắp xếp theo tên nút quy tắc tiến/nghịch/ngẫu nhiên/tham số
   ❖ Quy tắc tham số là các biểu thức chính quy hoặc từ khóa đơn giản, được kết nối với "<" hoặc ">"
   ❖ sắp xếp=🇭🇰>🇸🇬>🇯🇵>🇺🇸 , sắp xếp trước
   ❖ sort=IEPL<IPLC<BGP , sắp xếp sau
⦿ info=1, bật thông báo nhắc sân bay ✈️ thông tin luồng (nếu có);
⦿ lưu lượng=2022-06-02:1000:54, thời gian hết hạn đăng ký: tổng lưu lượng: lưu lượng đã sử dụng
⦿ trình giữ chỗ, có thể được sử dụng cho các thao tác như đổi tên/thay thế
   ❖ $type0/1/2/3/4/5/6/7 là trình giữ chỗ, lấy loại nút (ss/ssr/vmess, v.v.) làm tham số có thể thao tác, chẳng hạn như
     ∎ đổi tên=@|$type2
     ∎ Các phong cách là "𝐬𝐬", "𝐒𝐒", "🅢🅢", "🆂🆂", "ⓢⓢ", "🅂🅂", "𝕊𝕊", "ˢˢ"
   ❖ $index0/1/2/3/4/5/6/7/8 là trình giữ chỗ, lấy số sê-ri của nút làm tham số có thể thao tác, chẳng hạn như
     ∎ đổi tên=@「$index1」
     ∎ Các kiểu là 1\①\❶\⓵\𝟙\¹\₁\𝟏\𝟷
   ❖ $emoji1/2 placeholder, lấy biểu tượng cảm xúc (🇭🇰, v.v.) làm thông số có thể thao tác
     ∎ đổi tên=@「$emoji1」
   ❖ Giữ chỗ thẻ $, hãy sử dụng thẻ đã đăng ký làm tham số có thể hoạt động, chẳng hạn như
     ∎ Có thể được theo sau bởi các số để thêm kiểu chữ/số cho các thẻ riêng lẻ
     ∎ rename=@「$tag34」, cùng kiểu với ptn/npt bên dưới
⦿ ⟦Thông số nâng cao⟧: 𝘀𝗳𝗶𝗹𝘁𝗲𝗿/𝘀𝗿𝗲𝗻𝗮𝗺𝗲, chuyển vào tập lệnh được mã hóa base64, tập lệnh này có thể được sử dụng cho các yêu cầu [lọc/đổi tên] phức tạp hơn
   ❖ Mô tả: https://github.com/KOP-XIAO/QuantumultX/pull/9

2⃣️ ⟦𝐫𝐞𝐰𝐫𝐢𝐭𝐞 Viết lại ⟧/⟦𝐟𝐢𝐥𝐭𝐞𝐫 Tách ⟧ ➠ Mô tả thông số:
⦿ vào, ra, giữ lại/vô hiệu hóa shunt liên quan và viết lại các quy tắc theo từ khóa;
⦿ inhn, outhn, tên máy chủ "giữ/xóa" (𝒉𝒐𝒔𝒕𝒏𝒂𝒎𝒆);
   ❖ Minh chứng: vô hiệu hóa js "so sánh giá Taobao" và "weibo" trùng tên máy chủ
   𝐡𝐭𝐭𝐩𝐬://𝐦𝐲𝐥𝐢𝐬𝐭#out=tb_price.js+wb_ad.js&outhn=weibo
⦿ regex/regout, lưu giữ/xóa thông thường, vui lòng tự bỏ biểu thức chính quy;
   ❖ Có thể sử dụng cùng với in(hn)/out(hn), in(hn)/out(hn) sẽ được thực hiện trước;
   ❖ Dùng được cho cả 𝒉𝒐𝒔𝒕𝒏𝒂𝒎𝒆 & 𝐫𝐞𝐰𝐫𝐢𝐭𝐞/𝐟𝐢𝐥𝐭𝐞𝐫 (cẩn thận khi sử dụng)
⦿ tham số chính sách, được sử dụng để chỉ định trực tiếp nhóm chính sách hoặc tạo nhóm chính sách cho 𝐒𝐮𝐫𝐠𝐞 loại 𝗿𝘂𝗹𝗲-𝘀𝗲𝘁 (nhóm chính sách "𝐒𝐡𝐚𝐰𝐧" mặc định);
⦿ pset=regex1@policy1+regex2@policy2, chỉ định các nhóm chính sách khác nhau cho các từ khóa khác nhau (được phép sử dụng cụm từ thông dụng) trong cùng một quy tắc chuyển hướng;
⦿ thay thế tham số, thay thế thông thường 𝐟𝐢𝐥𝐭𝐞𝐫/𝐫𝐞𝐰𝐫𝐢𝐭𝐞 nội dung, regex@newregex;
   ❖ Thay thế tập lệnh trong So sánh giá trên Taobao bằng phiên bản rút gọn (nếu có tập lệnh của phiên bản này)
     ∎ replace=(price)(.*)@$1_lite$2
⦿ dst=viết lại/lọc, tương ứng chuyển đổi 𝐦𝐨𝐝𝐮𝐥𝐞&𝗿𝘂𝗹𝗲-𝘀𝗲𝘁 thành ghi lại/shunt;
   ❖ ⚠️ Chuyển đổi 𝐦𝐨𝐝𝐮𝐥𝐞 thành viết lại và 𝗿𝘂𝗹𝗲-𝘀𝗲𝘁 thành shunt theo mặc định
   ❖ ⚠️ Khi convert url-regex trong 𝗿𝘂𝗹𝗲-𝘀𝗲𝘁 để viết lại phải thêm dst=rewrite;
   ❖ ⚠️ Khi convert luật shunt trong 𝐦𝐨𝐝𝐮𝐥𝐞 phải thêm dst=filter
⦿ cdn=1, chuyển đổi địa chỉ của tập lệnh github thành fast.jsdelivr.net/gh
⦿ fcr=1/2/3, thêm tham số force-cellular/multi-interface/multi-interface-balance để phân chia quy tắc, buộc dữ liệu di động/dữ liệu hỗn hợp/cân bằng tải
⦿ via=interface, thêm tham số via-interface cho các quy tắc chia tách, 0 có nghĩa là via-interface=%TUN%
⦿ relay=tên chính sách đích, chuyển đổi đăng ký nút thành quy tắc ip/host theo đợt, được sử dụng để triển khai chuỗi proxy

3⃣️ Các thông số khác
⦿ Tham số thông báo ntf=0/1, dùng để đóng/mở thông báo trình phân giải tài nguyên
   ❖ 𝗿𝗲𝘄𝗿𝗶𝘁𝗲/𝗳𝗶𝗹𝘁𝗲𝗿 Lời nhắc thông báo được "bật" theo mặc định để tránh vô tình xóa các quy tắc
   ❖ Độ phân giải tài nguyên 𝘀𝗲𝗿𝘃𝗲𝗿 bị "đóng" theo mặc định
⦿ loại tham số type=domain-set/rule/module/list/nodes
   ❖ Khi trình phân tích cú pháp không nhận dạng đúng loại, bạn có thể thử sử dụng tham số này để buộc
⦿ Tham số ẩn hide=0, tắt tách/ghi lại quá trình lọc, cách mặc định là xóa
⦿ profile=111 , URL-Scheme thêm tài nguyên từ xa trong cấu hình loại QuanX
----------------------------------------------------------
*/

/**
* Hướng dẫn sử dụng,
0️⃣ Trong phần [chung] của tệp cấu hình QuantumultX, hãy thêm
resource_parser_url = https://raw.githubusercontent.com/KOP-XIAO/QuantumultX/master/Scripts/resource-parser.js
⚠️⚠️Nếu nó nhắc "Không có trình phân tích cú pháp tùy chỉnh", vui lòng nhấn và giữ biểu tượng ở góc dưới bên phải rồi nhấp vào nút làm mới ở bên trái để cập nhật tài nguyên và thoát khỏi ứng dụng trong nền cho đến khi mô tả trình phân tích cú pháp xuất hiện
...
if(version == 0) { $notify("⚠️ Vui lòng cập nhật Quantumult X lên phiên bản cửa hàng mới nhất\n", "🚦 Phiên bản hiện tại có thể không sử dụng được một số chức năng bình thường", "\n👉Nhấp vào liên kết cửa hàng để cập nhật",update_link) }
...
function Parser() {
  ...
  if (type0 != "web" && type0 != "wrong-field" && type0 != "JS-0"){
    try {
      ...
      if(Perror == 0) {
      $notify("❌ Đã xảy ra lỗi khi phân tích cú pháp", "⚠️ Vui lòng nhấp vào thông báo để gửi liên kết đăng ký để nhận phản hồi", err, bug_link);
    }
    }
    ...
    $notify( "⚠️ Vui lòng nhấp vào thông báo để nhảy và cố gắng thêm nó vào đúng loại", "❌ Loại phát hiện ["+typec+"]"+" xung đột với loại điền "+"["+typeQ+"]", "Nếu bước nhảy được thêm vào Không thành công, vui lòng gửi bot trình phân tích cú pháp phản hồi liên kết\n"+$resource.link, bug_linkx)
    } else {//旧版本
    $notify("❌ Loại phát hiện ["+typec+"]"+" xung đột với loại mục tiêu "+"["+typeQ+"]", "⚠️ Vui lòng tự kiểm tra nội dung của liên kết hoặc nhấp vào thông báo để gửi liên kết để đưa ra phản hồi", $resource.link, bug_link)
    }
    total=""
  } else {
    total=""
...
if (typeof($resource)!=="undefined" && PProfile == 0) {
  ...
  $notify("⚠️Vui lòng bỏ qua thông báo lỗi, nhấp vào thông báo này để chuyển", "Thêm tài nguyên từ xa hợp lệ trong cấu hình 👇 ["+ PProfile+"]", ADDres,openlink)
...
function ParseUnknown(cnt){
  try {
    cnt = JSON.parse(cnt)
    if(cnt) {
      $notify("⚠️ Nội dung do liên kết trả về không phải là đăng ký hợp lệ" + "⟦" + subtag + "⟧","⁉️ Vui lòng tự kiểm tra liên kết gốc, nội dung trả về 👇️👇️",JSON.stringify(cnt), bug_link)
    }
    
  } catch(err) {
    $notify("😭 Định dạng đăng ký không được nhận dạng: " + "⟦" + subtag + "⟧", "⚠️ sẽ được nhập trực tiếp vào Quantumult X \n Nếu bạn cho rằng đó là LỖI, vui lòng nhấp vào thông báo để nhảy và gửi phản hồi liên kết", "Liên kết trả về nội dung :\n"+cnt, bug_link);
  }
}
...
function ResourceParse() {
  ...
  if (type0 == "Subs-B64Encode") { // subs2QX 负责所有节点的转换
    ...
    //2023-03-06 考虑模块Viết lại与quanx类型Viết lại的混搭
    flag = 2 
    ...
    total = total.filter( (ele,pos)=>total.indexOf(ele) == pos); //Viết lại重复检查
    ...
    RegCheck(total, "bypass trích dẫn", "regex", Preg)
  } 
    if (Pregout && total.length!=0) { // 正则删除规则 filter
    total = total.map(RegexOut).filter(Boolean)
    RegCheck(total, "bypass trích dẫn", "regout", Pregout)
  }
    if (Preplace) { total = ReplaceReg(total, Preplace) }
    ...
    $notify("‼️ Trích dẫn" + "⟦" + subtag + "⟧" + "Nội dung trả về trống", "⁉️ Nhấp vào thông báo để xác nhận xem liên kết có hợp lệ hay không", para.split("#")[0], nan_link);
    flag = 0;
    ...
    Profile_Handle()
    openlink = {"open-url": ADDres}
    $notify("⚠️ Liên kết này là tệp cấu hình hoàn chỉnh, vui lòng nhấp vào thông báo này để chuyển", "Thêm tài nguyên từ xa hợp lệ trong cấu hình 👇 ["+ PProfile+"]", ADDres, openlink)
    flag = -1;
    total = ""
  } else if (type0 == "JS-0") {
    total = ""
  ...
  if (flag == 1) { //server 类型统一处理
    ...
    if (total.length > 0){
      ...
      if (Pcnt == 1) {$notify("⟦" + subtag + "⟧"+"Cuối cùng trả về nội dung sau khi phân tích cú pháp" , "Số nút:" +total.split("\n").length, total)}
      total = PRelay==""? Base64.encode(total) : ServerRelay(total.split("\n"),PRelay) //强制节点类型 base64 加密后再导入 Quantumult X, 如果是relay，则转换成bypass类型
      if(Pflow==1) {
        //$notify("添加Thông tin Traffic","xxx","xxxx")
        $done({ content: total, info: {bytes_used: 3073741824, bytes_remaining: 2147483648, expire_date: 1854193966}});
      //$notify("done?","strange")
      } else { $done({ content: total });}
    } else {
      if(Perror == 0) {
      $notify("❓❓ Nhắc nhở thân thiện ➟"+ "⟦" + subtag + "⟧", "⚠️⚠️ Không có nội dung hợp lệ sau khi phân tích cú pháp", "🚥🚥 Vui lòng tự kiểm tra các thông số liên quan hoặc nhấp vào thông báo để nhảy và gửi liên kết phản hồi", bug_link)
    }
      total = errornode
...
function SubFlow() {
  if (Pinfo == 1 && subinfo) {
    ...
    var usd = "Trafficc đã sử dụng: " + ((parseFloat(sinfo.indexOf("upload")!=-1?sinfo.split("upload=")[1].split(",")[0]:"0") + parseFloat(sinfo.split("download=")[1].split(",")[0])) / (1024 ** 3)).toFixed(2) + "GB"
    var left = "Còn: " + ((parseFloat(sinfo.split("total=")[1].split(",")[0]) / (1024 ** 3)) - ((parseFloat(sinfo.indexOf("upload")!=-1?sinfo.split("upload=")[1].split(",")[0]:"0") + parseFloat(sinfo.split("download=")[1].split(",")[0])) / (1024 ** 3))).toFixed(2) + "GB"
    ...
    var message = total + "\n" + usd + ", " + left;
    ntf_flow = 1;
    $notify("Thông tin Traffic: ⟦" + subtag + "⟧", epr, message, subinfo_link)
  }
//  } else if (Pinfo ==1){
//    $notify("Thông tin Traffic: ⟦" + subtag + "⟧", "", "⚠️ 该订阅链接未返回任何Thông tin Traffic", subinfo_link)
//  }
}
...
function flowcheck(cnt) {
  ...
  exptime = exptime? exptime:"⚠️ Thuê bao không trả lại thông tin thời gian sử dụng gói"
    if (flow != "") { $notify("Thông tin Traffic: ⟦" + subtag + "⟧", flow, exptime, subinfo_link1) }
}

// regex 后的检查
function RegCheck(total, typen, paraname,regpara) {
  if(total.length == 0){ 
    $notify("‼️ " + typen + "  ➟ " + "⟦" + subtag + "⟧", "⛔️ lọc thông thường: " + paraname + "=" + regpara, "⚠️ Sau khi lọc, các mục còn lại là 0️⃣, vui lòng kiểm tra thông số thường xuyên và link gốc", nan_link)
  }else if((typen != "节点订阅" && Pntf0 !=0) || (typen == "节点订阅" && Pntf0 ==1)){
    var nolist = total.length <= 10 ? emojino[total.length] : total.length
    $notify("🤖 " + typen + "  ➟ " + "⟦" + subtag + "⟧", "⛔️ lọc thường xuyên: " + paraname + "=" + regpara, "⚠️ Sau khi lọc còn lại những thứ sau" + nolist + "matches \n ⨷ " + total.join("\n ⨷ "), sub_link)
  }
}
//判断订阅类型
function Type_Check(subs) {
    ...
    const RewriteCheck = (item) => subs.indexOf(item) != -1 ; // quanx Viết lại判定
    ...
    if ( (subs.indexOf(html) != -1 || subs.indexOf("doctype html") != -1) && link0.indexOf("github.com" == -1)) {
      $notify("‼️ Liên kết được trả về là nội dung trang không hợp lệ"+ " ➟ " + "⟦" + subtag + "⟧", "⁉️ Nhấp vào bước nhảy thông báo để xác nhận xem liên kết có hợp lệ hay không\n"+link0, "Nội dung trả về như sau⬇️：\n"+subs, nan_link);
      type = "web";
      ...
      Perror = 1 ; // 无需反馈
      $notify("⚠️ Nội dung của liên kết bạn đã nhập là tập lệnh JS", "Không có quy tắc viết lại trong tập lệnh 🚥 nên không thể phân tích cú pháp và sử dụng nó", " Vui lòng ⚠️Đừng ⚠️ đến trình phân tích cú pháp 🤖️ để nhận phản hồi \n"+link0)
      type = "JS-0"
  ...
  // 用于通知判断类型，debug
  if(typeU == "X"){
    $notify("Loại quyết định liên kết",type+" : " +typec, subs)
  }
  //$notify(type)
    return type
}
...
function TagCheck_QX(content) {
  ...
  console.log(content)
    ...
    if (nulllist.length >= 1) {
        ...
        $notify("⚠️ trích dẫn" + "⟦" + subtag + "⟧" + " chứa" + no + "tên nút trống", "✅ nút loại IP đã được đặt làm tên nút", " ⨁ " + nulllist.join("\n ⨁ "), nan_link)
    }
    if (duplist.length >= 1) {
        no = duplist.length <= 10 ? emojino[duplist.length] : duplist.length;
      if (Pdel!=1 && Pntf0 != 0){
        $notify("⚠️ trích dẫn" + "⟦" + subtag + "⟧" + " chứa" + no + "các nút có tên trùng lặp ", "✅ Phân biệt số đã được thêm vào, vui lòng thêm tham số để xóa del=1:", " ⨁ " + duplist.join("\n ⨁ "), nan_link)
      } else if (Pdel ==1 && Pntf0 != 0) {
        $notify("⚠️ trích dẫn" + "⟦" + subtag + "⟧" + " chứa" + no + "các nút có tên trùng lặp ", "❌️ Tất cả đã bị xóa, vui lòng bỏ tham số nếu muốn giữ lại del=1:", " ⨁ " + duplist.join("\n ⨁ "), nan_link)
      }
    }
    return Nlist
}
...
function ToRaw(cnt) {
  ...
  if (cnt) {
    $notify( "⚠️⚠️ sẽ cố gắng giải quyết tài nguyên" + "⟦" + subtag + "⟧" , "🚥 Vui lòng sử dụng đúng liên kết raw của GitHub" , "❌ liên kết của bạn："+link0+"\n✅ liên kết chính xác："+rawlink, {"open-url":rawlink})
  } else if(content0.indexOf("gridcell")!=-1) {
    $notify( "⚠️⚠️ phân tích tài nguyên" + " ⟦" + subtag + "⟧ thất bại" , "🚥 liên kết của bạn có vẻ như là một thư mục, không phải là một tập tin" , "❌ liên kết của bạn："+link0, {"open-url":link0})
  }
  return cnt
}
...
//url-regex 转换成 Quantumult X Viết lại
...
function SCP2QX(subs) {
  ...
  for (var i = 0; i < subs.length; i++) {
    try {
      ...
      const notecheck = (item) => subs[i].indexOf(item) == 0
      const RewriteCheck = (item) => subs[i].indexOf(item) != -1 ; // quanx Viết lại判定
      ...
      $notify("❌️Lỗi phân tích cú pháp mục nhập này, bị bỏ qua",subs[i],err)
    }
  }
  return nrw
}
...
//Rewrite过滤，使用+连接多个关键词(逻辑"或"):in 为dự trữ，out 为排除
function Rewrite_Filter(subs, Pin, Pout,Preg,Pregout) {
    ...
    if (Pntf0 != 0) {
        ...
        if (Pin0 && no1write != " 0️⃣ ") { //有 in 参数就通知dự trữ项目
          if (Pout!=0) {
            $notify("🤖 " + "viết lại trích dẫn  ➟ " + "⟦" + subtag + "⟧", "⛔️ tham số bộ lọc: " + pfi + pfo, "☠️ Viết lại rewrite giữ những điều sau đây" + no1write + "matches:" + "\n ⨷ " + Nlist.join("\n ⨷ "), rwrite_link)
          }
        } else if (dwrite.length > 0) {
          if (Pout0!=0) {
            $notify("🤖 " + "Viết lại trích dẫn  ➟ " + "⟦" + subtag + "⟧", "⛔️ tham số bộ lọc: " + pfi + pfo, "☠️ Viết lại rewrite những điều sau đây bị vô hiệu hóa trong" + nowrite + "matches:" + "\n ⨷ " + dwrite.join("\n ⨷ "), rwrite_link)
          }
        }
    }
    if (Nlist.length == 0 ) { 
      if ((Pin0 || Pout0 || Phin0 || Phout0 || Pregout || Preg)) {
        $notify("🤖 " + "Viết lại trích dẫn  ➟ " + "⟦" + subtag + "⟧", "⛔️ tham số bộ lọc: " + pfi + pfo, "⚠️ Sau khi lọc, số luật rewrite còn lại là 0️⃣, Vui lòng kiểm tra thông số và liên kết gốc", nan_link) 
      } else {
        $notify("🤖 " + "Viết lại trích dẫn  ➟ " + "⟦" + subtag + "⟧", "⛔️ Sau khi phân tích cú pháp, số quy tắc rewrite là 0️⃣ " , "⚠️ Vui lòng kiểm tra thông số và nội dung liên kết gốc", nan_link) 
    ...
    if (Pntf0 != 0) {
        if (paraout || parain) {
            ...
            if (parain && no1name != " 0️⃣ ") {
                $notify("🤖 " + "Viết lại trích dẫn  ➟ " + "⟦" + subtag + "⟧", "⛔️ tham số bộ lọc: " + pfihn + pfohn, "☠️ Tên hostname đã đặt trước" + no1name + "matches:" + "\n ⨷ " + nname.join(","), rwhost_link)
            } else if (dname.length > 0) {
                $notify("🤖 " + "Viết lại trích dẫn  ➟ " + "⟦" + subtag + "⟧", "⛔️ tham số bộ lọc: " + pfihn + pfohn, "☠️ Phần sau đã bị xóa khỏi tên hostname" + noname + "matches:" + "\n ⨷ " + dname.join(","), rwhost_link)
            }
        }
    }
    if (nname.length == 0) {
        $notify("🤖 " + "Viết lại trích dẫn  ➟ " + "⟦" + subtag + "⟧", "⛔️ tham số bộ lọc: " + pfihn + pfohn, "⚠️ Còn 0️⃣ mục trong hostname, vui lòng kiểm tra lại thông số và link gốc", nan_link)
    }
...
//bypass规则转换及过滤(in&out)，可用于 surge 及 quanx 的 rule-list
function Rule_Handle(subs, Pout, Pin) {
    ...
    if (Tout != "" && Tout != null) { // 有 out 参数时
        ...
        for (var i = 0; i < cnt.length; i++) {
            ...
            if (Tout.some(exclude) && !RuleK.some(CommentCheck) ) {
              ...
              // 2022-12-15 删除 && RuleK2.some(RuleCheck) 判断条件，以免 list/provider 中参数上生效
                dd = Rule_Policy(cc);
                if (Tin != "" && Tin != null) {
                    const include = (item) => dd.indexOf(item) != -1; // dự trữ项
                    if (Tin.some(include)) {
                        nlist.push(dd);
                    }
                } else {
        ...
        if (dlist.length > 0) {
            if (Pntf0 != 0) { $notify("🤖 " + "bypass trích dẫn  ➟ " + "⟦" + subtag + "⟧", "⛔️ disabled: " + Tout, "☠️ đã bị vô hiệu hóa dưới đây" + no + "quy tắc phù hợp:" + "\n ⨷ " + dlist.join("\n ⨷ "), rule_link) }
        } else { $notify("🤖 " + "bypass trích dẫn  ➟ " + "⟦" + subtag + "⟧", "⛔️ disabled: " + Tout, "⚠️ Không tìm thấy kết quả phù hợp, vui lòng kiểm tra thông số hoặc liên kết gốc", nan_link) }
        if (Tin != "" && Tin != null) {  //有 in 跟 out 参数时
            if (nlist.length > 0) {
                var noin0 = nlist.length <= 10 ? emojino[nlist.length] : nlist.length
                if (Pntf0 != 0) {
                    $notify("🤖 " + "bypass trích dẫn  ➟ " + "⟦" + subtag + "⟧", "✅ dự trữ:" + Tin, "🎯 dự kiến ​​lưu trữ bên dưới " + noin0 + "quy tắc phù hợp:" + "\n ⨁ " + nlist.join("\n ⨁ "), rule_link)
                }
            } else {
                $notify("🤖 " + "bypass trích dẫn  ➟ " + "⟦" + subtag + "⟧", "✅ dự trữ:" + Tin + ",⛔️ disabled: " + Tout, "⚠️ Sau khi lọc, số lượng luật còn lại là 0️⃣, vui lòng kiểm tra thông số và link gốc", nan_link)
            }
        } else {// if Tin (No Tin)
            if (nlist.length == 0) {
                $notify("🤖 " + "bypass trích dẫn  ➟ " + "⟦" + subtag + "⟧", "⛔️ disabled: " + Tout, "⚠️ Sau khi lọc, số lượng luật còn lại là 0️⃣, vui lòng kiểm tra thông số và link gốc", nan_link)
            }
        }
      nlist =Phide ==1? nlist : [...dlist,...nlist]
        ...
        if (nlist.length > 0) {
            ...
            if (Pntf0 != 0) {
                $notify("🤖 " + "bypass trích dẫn  ➟ " + "⟦" + subtag + "⟧", "✅ dự trữ:" + Tin, "🎯 dự kiến ​​lưu trữ bên dưới " + noin + "quy tắc phù hợp:" + "\n ⨁ " + nlist.join("\n ⨁ "), rule_link)
            }
        } else { $notify("🤖 " + "bypass trích dẫn  ➟ " + "⟦" + subtag + "⟧", "✅ dự trữ:" + Tin, "⚠️ Sau khi lọc, số lượng luật còn lại là 0️⃣, vui lòng kiểm tra thông số và link gốc", nan_link) }
      nlist =Phide ==1? nlist : [...dlist,...nlist]
      //return nlist;
    } else {  //if Tin
            ...
            try {
              if (Pdbg) {$notify(i, type, list0[i])}
                if (type == "vmess" && (list0[i].indexOf("remark=") == -1 && list0[i].indexOf("remarks=") == -1) && !/(obfs|alterId|type)\=/.test(list0[i])) {
                  ...
                  Perror = 1 ; // 无需反馈
                  $notify("⚠️ Quantumult X chưa hỗ trợ các nút loại Vless","Vui lòng ⚠️Đừng⚠️ Hãy đến với trình phân tích cú pháp🤖️ Phản hồi",list0[i])
                }
            } catch (e) {
                failedList.push(`<<<\nContent: ${list0[i]}\nError: ${e}`)
            }
...
function VR2QX(subs, Pudp, Ptfo, Pcert0, PTls13) {
  ...
  if (obfs == "none") { //
    ...
    Perror = 1 // 不需要反馈的类型
    if (Pntf0!=0) {
    $notify( "⚠️ Quantumult X hiện không hỗ trợ loại nút này", "Các nút grpc|h2 vmess sau đây đã bị bỏ qua",subs)
  }
    pdrop = 1
  }
  if (obfs.indexOf("obfs=over-tls") != -1 || obfs.indexOf("obfs=wss") != -1) {
...
//节点过滤，使用+连接多个关键词(逻辑"或"):in 为dự trữ，out 为排除, "与"逻辑请用符号"."连接
function Filter(servers, Pin, Pout) {
    ...
    for (var i = 0; i < servers.length; i++) {
        ...
        } else { Delist.push(servers[i].replace(/ /g, "").split("tag=")[1]) } //记录未被dự trữ节点
    }//for
    ...
    if (Pntf0 == 1 && Delist.length >= 1) {//通知部分
        if (Pin && no1 > 0) { //有 in 参数就通知dự trữ部分
            $notify("👥 trích dẫn" + "⟦" + subtag + "⟧" + " bắt đầu lọc nút", "🕹 lọc từ khóa: " + pfi + pfo, "☠️ dự kiến ​​lưu trữ bên dưới " + no1 + "nodes\n" + Nname.join(", "), sub_link);
        } else if (Pout && no > 0) {
            $notify("👥 trích dẫn" + "⟦" + subtag + "⟧" + " bắt đầu lọc nút", "🕹 lọc từ khóa: " + pfi + pfo, "☠️ Đã xóa phần sau " + no + "nodes\n" + Delist.join(", "), sub_link);
        }
    } else if (no1 == 0 || no1 == null) { //无剩余节点时强制通知
        $notify("‼️ ⟦" + subtag + "⟧" + "Số nút sau khi lọc là 0️⃣", "⚠️ Vui lòng kiểm tra lại link gốc và tự tham số bộ lọc", link0, sub_link);
    }
    return Nlist
}

function FilterScript(servers, script) {
    $notify("🤖 Kích hoạt tập lệnh để lọc", "", script);
    try {
        const $ = Tools();
        eval(script);
        // extract server tags
        ...
        $notify("❌ lỗi bộ lọc tập lệnh", "", err);
        return servers;
    }
}
...
try {
  ...
  if(Perror == 0) {
  $notify("❌ Đã xảy ra lỗi khi phân tích cú pháp và mục nhập này đã bị bỏ qua", "⚠️ Vui lòng nhấp vào thông báo để gửi liên kết đăng ký để nhận phản hồi", cntf+"\n"+ err, bug_link);
}
}
  return ""
}
...
function RenameScript(servers, script) {
    ...
    try {
        ...
        $notify("❌ Lỗi khi đổi tên tập lệnh", "", err);
        return servers;
    }
...
function get_emoji(emojip, sname) {
   var Lmoji = { 
    "🏳️‍🌈": ["Lưu lượng", "Gói", "Còn lại", "Đặt lại", "Hết hạn", "Thời gian", "Khẩn cấp", "Hết hạn", "Bandwidth", "expire", "Traffic", "traffic"],
    "🇴🇲": ["ô-man", " OM "],
    "🇦🇩": ["Andorra", "Andorra"],
    "🇦🇿": ["A-déc-bai-gian","Azerbaijan"],
    "🇦🇹": ["Áo", "Áo", "Austria", "Vienna"],
    "🇦🇺": ["AU", "Australia", "Sydney", "Australia", "Australia", "Melbourne", "Sydney", "Tu'ao", "Jing'ao", "Guang'ao", "Shanghai-Australia", "Shanghai-Australia", "Guang'ao"],
    "🇧🇪": ["BE", "Bỉ","Bỉ","Belgium"],
    "🇧🇬": ["Bungari", "Bungari","Bulgaria"],
    "🇵🇰": ["Pa-ki-xtan","Pakistan", "PAKISTAN"],
    "🇧🇭": ["Bahrain","Bahrain"],
    "🇵🇾": ["Paraguay","Paraguay"],
    "🇰🇭": ["Campuchia","Cambodia"],
    "🇺🇦": ["Ukraine","Ukraine","Ukraina"],
     ...
     "🇨🇦": ["CA", "Canada", "CANADA", "CAN", "Waterloo", "Canada", "Montreal", "Vancouver", "Maple Leaf", "Maple Leaf", "Waterloo ", "Toronto"],
     "🇨🇭": ["Thụy Sĩ", "Zurich", "Thụy Sĩ", "CH "],
     "🇳🇬": ["Nigeria", "NG", "Nigeria","Lagos", "Nigeria"],
     "🇨🇿": ["Séc", "Cộng hòa Séc"],
     "🇸🇰": ["Slovakia", "SK" , "Slovakia"],
     "🇸🇮": ["Slovenia", "Slovenia", "Slovenia"],
     "🇦🇲": ["Armenia", "Armenia", "Armenia"],
     "🇷🇸": ["RS ","RS_", "Serbia", "Serbia", "Seville", "Sevilla"],
     "🇲🇩": ["Moldova","MD","Moldova", "Moldova"],
     "🇩🇪": ["DE ", "DE-", "DE_", "German", "GERMAN", "Đức", "Đức", "Frankfurt", "Jingde", "Hude", "Guangde" , "Hude", "Quảng Đức"],
     "🇩🇰": ["DK","DNK","Đan Mạch","Đan Mạch", "Đan Mạch"],
     "🇪🇸": ["ES", "Tây Ban Nha", "Tây Ban Nha"],
     "🇪🇺": ["EU", "Liên minh châu Âu", "Châu Âu", "Châu Âu", "Châu Âu"],
     "🇫🇮": ["Phần Lan", "Phần Lan","Phần Lan","Helsinki"],
     "🇫🇷": ["FR", "Pháp", "Pháp", "Pháp", "Paris"],
     "🇷🇪": ["Đoàn tụ", "Đoàn tụ", "Đoàn tụ", "Đoàn tụ"],
     "🇨🇼": ["Curaçao", "Curaçao", "Curacao"],
     "🇬🇧": ["UK", "GB", "England", "United Kingdom", "United Kingdom", "London", "English"],
     "🇲🇴": ["MO", "Macao", "Macau", "MAC", "Macau", "Macau", "CTM"],
     "🇰🇿": ["Kazakhstan", "Kazakhstan", "Kazakhstan"],
     "🇱🇦": ["Lào", "Lào", "Lào"],
     "🇭🇺": ["Hungary", "Hungary"],
     "🇱🇹": ["Litva", "Litva"],
     "🇱🇰": ["Sri Lanka", "Sri Lanka", "Sri Lanka"],
     "🇧🇾": ["BỞI","Belarus","Belarus", "White Russia", "Republic of Belarus", "Belarus"],
     "🇷🇺": ["RU ","RU-", "RU_", "RUS", "Nga", "Nga", "Maozi", "Nga", "Nga", "Kabali", "Moscow" , "St. Petersburg", "Siberia", "Novosibirsk", "Jing-Nga", "Hàng-Nga", "Quảng-Nga", "Thượng-Nga", "Quảng-Nga", "Thượng-Nga" ],
     "🇸🇬": ["SG", "Singapore", "SINGAPORE", "Singapore", "Singapore", "Singapore", "Shanghai", "Jingxin", "Quanxin", "Suixin", "Shenxin", "Hangxin", "Guangxin", "Guangxin", "Shanghai"],
     "🇺🇸": ["US", "USA", "America", "United States", "United States", "美", "Jingmei", "Portland", "Dallas", "Oregon", "Phoenix ", "Fremont", "Thung lũng Silicon", "Thung lũng Silicon", "Las Vegas", "Los Angeles", "San Jose", "San Jose", "Santa Clara", "Seattle", "Chicago"," Humei", "Columbus", "New York"],
     "🇹🇼": ["TW", "Đài Loan","ĐÀI LOAN", "Đài Loan", "Đài Bắc", "Đài Trung", "Đài Bắc mới", "Chương Hóa", "CHT", "Đài Loan", "HINET" ] ,
     "🇮🇩": ["ID ", "IDN ", "Indonesia", "Indonesia", "Indonesia", "Jakarta"],
     "🇮🇪": ["Ireland", "Ireland", "IE", "Ireland", "Ireland", "Dublin"],
     "🇮🇱": ["Israel", "Israel"],
     "🇮🇳": ["Ấn Độ", "IND", "INDIA","Ấn Độ", "Mumbai", "Mumbai","IN "],
     "🇮🇸": ["IS","ISL", "Iceland","Iceland", "Iceland"],
     "🇰🇵": ["KP", "Bắc Triều Tiên", "Bắc Triều Tiên"],
     "🇰🇷": ["KR", "Hàn Quốc", "KOR", "Hàn Quốc", "Seoul", "Hàn Quốc", "Hàn Quốc", "Chuncheon"],
    "🇬🇭": ["Ghana", "Ghana"],
     "🇱🇺": ["Luxembourg", "LU ", "Luxembourg"],
     "🇱🇻": ["Latvia", "Latvija", "Latvia"],
     "🇧🇩": ["Bengal", "Bengal"],
     "🇲🇽️": ["MEX", "MX", "Mexico", "Mexico", "MEXICO"],
     "🇲🇾": ["MY", "Malaysia", "MALAYSIA", "Malaysia", "Malay", "Malay", "Malaysia", "Malaysia", "Malaysia", "Kuala Lumpur"] ,
     "🇲🇲": ["Myanmar"],
     "🇳🇱": ["NL", "Hà Lan", "Hà Lan", "Hà Lan", "Hà Lan", "Amsterdam"],
     "🇵🇭": ["PH", "Philippines", "Philippines", "Philippines"],
     "🇷🇴": [" RO ", "Romania", "Rumania"],
     "🇸🇦": ["Saudi Arabia", "Riyadh", "Saudi Arabia", "Saudi"],
     "🇸🇪": ["SE", "Thụy Điển","Thụy Điển"],
     "🇹🇭": ["TH", "Thái Lan", "Thái Lan", "Thái Lan", "Bangkok"],
     "🇹🇷": ["TR ","TR-", "TR_", "TUR", "Turkey", "Turkey", "Istanbul"],
     "🇻🇳": ["VN", "Việt Nam", "Thành phố Hồ Chí Minh", "Việt Nam"],
     "🇮🇹": ["Ý", "IT", "Nachash", "Ý", "Milan", "Ý"],
     "🇿🇦": ["Nam Phi", "Nam Phi", "Johannesburg"],
     "🇦🇪": ["Các Tiểu vương quốc Ả Rập Thống nhất", "UAE", "AE", "Dubai", "Dubai"],
     "🇧🇷": ["BR", "Braxin", "Braxin", "Sao Paulo"],
     "🇯🇵": ["JP", "Nhật Bản", "Nhật Bản", "Nhật Bản", "Tokyo", "Osaka", "Saitama", "Jingri", "Suri", "Shanghai", "Shangri", "Suiri", "Chuanri", "Zhongri", "Quanri", "Hangri", "Shenri", "Liaori", "Guangri", "Tokyo"],
     "🇦🇷": ["AR", "Argentina", "Argentina"],
     "🇳🇴": ["Na Uy", "Na Uy", "KHÔNG"],
     "🇵🇱": ["PL", "POL", "Ba Lan","Ba Lan", "Ba Lan"],
     "🇨🇱": ["Chile","Chile","CHILE"],
     "🇳🇿": ["New Zealand","New Zealand", "New Zealand"],
     "🇬🇷": ["Hy Lạp","Hy Lạp", "Hy Lạp"],
     "🇪🇬": ["Ai Cập", "Ai Cập"],
     "🇮🇲": ["Isle of Man", "Isle of Man", "Isle of Man", "Mannin"],
     ...
     "🇲🇹": ["Malta", "Malta"],
     "🇻🇪": ["Venezuela", "Venezuela"],
     "🇧🇦": ["Bosnia và Herzegovina", "Bosnia và Herzegovina", "Bosnia và Herzegovina"],
    ...
    "🇰🇪": ["Kenya", "Kenya", "Kenya"],
     "🇰🇬": ["Kyrgyzstan","Kyrgyzstan", "Kyrghyzstan"],
     "🇳🇵": ["Nepal", "Nepal"],
     "🇽🇰": ["Kosovo", "Kosovo"],
     "🇲🇦": ["Ma-rốc", "Ma-rốc"],
     "🇪🇨": ["Ecuador","EC", "Ecuador"],
     ...
     "🇬🇹": ["Guatemala", " GT "],
     "🇭🇰": ["HK", "Hongkong", "Hong Kong", "HongKong", "HONG KONG", "Hong Kong", "Shenzhen Hong Kong", "Shanghai Hong Kong", "Hu Hong Kong" , "HKT" , "HKBN", "HGC", "WTT", "CMI", "Suigang", "Jinggang", "Hong Kong"],
     "🇨🇳": ["CN", "Trung Quốc", "Trở về", "Trung Quốc", "Trung Quốc", "Giang Tô", "Bắc Kinh", "Thượng Hải", "Quảng Châu", "Thâm Quyến", "Hàng Châu", "Từ Châu", "Thanh Đảo", "Ninh Ba", "Trấn Giang", "back"],
     "🇱🇮": ["Liechtenstein"],
     "🇬🇺": ["Guam"],
     "🇮🇶": ["Iraq"],
     "🇸🇨": ["Seychelles"],
     "🇱🇧": ["Lebanon","LB", "Lebanon"],
     "🇧🇳": ["Brunei","BRN","Negara Brunei Darussalam"],
     "🌏": ["Châu Á","Asia"]
  }
...
function Clash2QX(cnt) {
  ...
  for (i=0; i<nl; i++){
    try{
      ...
      $notify(`⚠️Nút này được phân tích cú pháp không chính xác, hiện tại nó đã bị bỏ qua`, `nhấp vào thông báo và gửi liên kết phản hồi cho bot`,JSON.stringify(node),bug_link )
      $notify(`⚠️Nội dung lỗi như sau`, `bạn có thể copy nội dung lỗi vào bot phản hồi`,JSON.stringify(node)+"\n\n"+e)
    }
  }
